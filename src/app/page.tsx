...
const FEATURES: { title: string; body: string }[] = [
  ...
  { title: "Schedules & headless service", body: "“Every weekday at 8am, summarize my open issues and send it to Telegram.” A background service runs your automations with the IDE closed." },
...
const STAGES: { tag: string; cls?: string; title: string; body: string }[] = [
  ...
  { tag: "Stages B–D · Shipped", cls: "done", title: "Orchestration IDE", body: "Full canvas authoring, the orchestrator with event-log replay, the live agent map, the MRGD engine and inspector, real media generation with best-of-k, and cost dashboards." },
  { tag: "Stage E · Shipped", cls: "done", title: "The service split", body: "One headless service, many surfaces: the IDE attaches as a client, a CLI, chat sessions, and persistent memory." },
