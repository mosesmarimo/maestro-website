    ...
    "@graph": [
      {
        ...
        mainEntityOfPage: `https://maestrostudio.dev/docs/manual/${slug}`,
      },
      {
        "@type": "BreadcrumbList",
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "Documentation", item: "https://maestrostudio.dev/docs" },
          { "@type": "ListItem", position: 2, name: "User manual", item: "https://maestrostudio.dev/docs/manual" },
          { "@type": "ListItem", position: 3, name: chapter.title, item: `https://maestrostudio.dev/docs/manual/${slug}` },
        ],
      },
    ],
  };
